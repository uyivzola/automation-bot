...
def elite_paket():
    ...
    df_tovar_elite = df[df['TypeTovSkdikda'].str.contains(r'Мини пакет \d')]

    df_final = pd.merge(df_tovar_elite, region_df[['ClientMan', 'Region']], left_on='ClientMan', right_on='ClientMan',
                        how='left')
